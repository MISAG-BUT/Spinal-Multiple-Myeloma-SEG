...
def main(args):
    ...
    path_to_DICOM_folders = args.path_to_DICOM_folders #path to the DICOM folders, which are organized by patient ID and then by series description
    path_to_segmentations = args.path_to_segmentations #path to the segmentation masks, which are organized by patient ID and then by mask type (spine or lesions)
